...
class starter {
	public static void main(String args[]) {
        ...
        int totalBaskets; // from previous
        ...
        int cookiesPerStudentInt; // from previous
        ...
        double cookiesPerStudentDouble; // from previous
        cookiesPerStudentDouble = (double)totalCookies / studentsInClass;
        ...
        int leftoverCookies; // from previous
        ...
        double totalCost; // from previous
